...
export const EVAL_ARMS: Record<EvalArmId, EvalArm> = {
  ...
  rag_hybrid: {
    id: 'rag_hybrid',
    label: 'RAG híbrido + expansão + gate (algoritmo próprio)',
    short: 'Alg. próprio',
    mode: 'rag',
  ...
  rag_search: {
    id: 'rag_search',
    label: 'Algoritmo próprio · think (busca extra dirigida pelo modelo)',
    short: 'Alg. think',
    description: 'Algoritmo próprio em que o modelo pode pedir buscas adicionais (<buscar>…</buscar>) antes de responder, até 2 rodadas. Mais lento; mira os erros de recuperação.',
    mode: 'rag',
