...
| Métrica | Doc. inteiro | RAG vetorial | Algoritmo próprio | Algoritmo think |
|---|---|---|---|---|
...
| Sonnet 5 | Algoritmo próprio | 91% / 89% | 87% / 87% | 93% / 84% | 7 (1 em todas) |
| Sonnet 5 | Algoritmo think | 100% / 91% | 98% / 96% | 96% / 93% | 3 (0 em todas) |
| Haiku 4.5 | Doc. inteiro | 89% / 58% | 89% / 53% | 91% / 62% | 10 (1 em todas) |
| Haiku 4.5 | RAG vetorial | 71% / 53% | 73% / 51% | 71% / 51% | 16 (10 em todas) |
| Haiku 4.5 | Algoritmo próprio | 89% / 89% | 84% / 76% | 93% / 93% | 11 (1 em todas) |
| Haiku 4.5 | Algoritmo think | 91% / 91% | 87% / 87% | 98% / 98% | 8 (1 em todas) |

## Por edital (sem referência / com referência, média das repetições)

| Edital | Modelo | Doc. inteiro | RAG vetorial | Algoritmo próprio | Algoritmo think |
|---|---|---|---|---|---|
...
| Tema | Modelo | Doc. inteiro | RAG vetorial | Algoritmo próprio | Algoritmo think |
|---|---|---|---|---|---|
...
- 48 respostas apontadas: 20 aceitas e **28 contadas como erradas** (11 no documento inteiro, 5 no RAG vetorial, 9 no algoritmo proposto e 3 no think).
